                      ...
                      <td className="px-4 py-3" data-testid={`cell-crm-${upload.id}`}>
                        {upload.zohoProductId ? (
                          <a
                            ...
                            className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 hover:opacity-80 transition-opacity"
                          >
                            View in CRM
                          </a>
                        ) : upload.status === 'Approved' ? (
